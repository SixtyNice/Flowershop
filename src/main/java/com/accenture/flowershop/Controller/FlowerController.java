...
public class FlowerController {
    ...
    public ResponseEntity<FlowerEntity> getFlowerByName(@PathVariable("name") String name) {
        FlowerEntity flowerEntity = flowerService.getFlowerByName(name);
    ...
    public ResponseEntity<List<FlowerEntity>> getFlowerByPrice(@RequestParam("priceFrom") int priceFrom, @RequestParam("priceTo") int priceTo) {
        List<FlowerEntity> flowerEntityList = flowerService.getFlowersByPrice(priceFrom, priceTo);
